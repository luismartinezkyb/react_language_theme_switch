...
const pages = ['About Me', 'Skills', 'Experience', 'Career', 'Contact', 'Blog'];
const settings = ['Profile', 'Account', 'Dashboard', 'Logout'];

function NavBar({themeColor, toggleTheme}) {
    ...
    <AppBar position="static" style={{marginBottom:'25px'}}>
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          {themeColor === 'dark' ? <LightMode/> : <DarkMode/>}
          <Switch onChange={toggleTheme} checked={themeColor==="dark"? true:false}></Switch>
          
          <Box sx={{ flexGrow: 0 }}>
            <Tooltip title="Open settings">
              <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                <Avatar alt="Remy Sharp" src="https://avatars.githubusercontent.com/u/89945446?v=4" />
              </IconButton>
            </Tooltip>
            <Menu
              sx={{ mt: '45px' }}
